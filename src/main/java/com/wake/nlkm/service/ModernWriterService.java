...
public interface ModernWriterService {
    /**
     *  批量查询现代作家
     * @param name
     * @param page
     ...
     * @return
     */
    ModernWriter queryWriterInfoById(Integer writerid) throws Exception;
     ...
     * @return
     */
    int addWriterInfo(ModernWriter writerInfo) throws Exception;
     ...
     * @return
     */
    int updateWriterInfo(ModernWriter writerInfo) throws Exception;
